...
if(isset($_POST['searchtext']))
{
    ...
    //Select bookid, name, description, image, author, quantity,price from bookstore.product where name like "%arry%" OR author like "%o%";
    $stmt="Select bookid, name, description, image, author, quantity,price from bookstore.product where name like '%".$txt."%' OR author like '%".$txt."%'";
...
<h1 style="color:white">hello this is search page</h1>
