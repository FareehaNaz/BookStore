    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col">
        <div class="table-responsive">
            <center>
            <form action="addproducttodatabase.php" method="post" enctype="multipart/form-data">
                <table >
                    <tr><td><input type="file" name="image" required></td></tr>
                    <tr><td><input type="text" name="bookname" placeholder="Book Name" required></td></tr>
                    <tr><td><input type="text" name="description" placeholder="Description" required></td></tr>
                    <tr><td><input type="text" name="author" placeholder="Author" required></td></tr>
                    <tr><td><input type="number" name="quantity" min="1" placeholder="Qty" required></td></tr>
                    <tr><td><input type="number" name="price" min="1" placeholder="$" required></td></tr>
                    </table>
                    <input class="btn btn-dark btn-block" type="submit" value="Add" name="add">
            </form> 
            </center>
            <br><br>
          <table class="table">
